...
# ----------------------------------------------------
fps=380 #frames /sec MAKO U051B max = 391 theo, vrai 380 - optimal 350
exposure=2 #msec BE CAREFUL : 1 or 2 msec (3 does not work for fps 380)
showevery=100 #frames : fps/10 au min, 100 c'est mieux
...
with Vimba() as vimba:
    ...
    while 1:
        ...
        if success:
            ...
            stockageram[str(temps)]=blanck(frame.height,frame.width,1)
